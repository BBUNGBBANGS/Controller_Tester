#line 2 "cs_test%qBufGet_test0%cs_error"
/* qBufGet_test0.c */
#ifndef __qBufGet_test0__
#define __qBufGet_test0__

#include "../factory/factory.h"

#include "qBufGet_test0.h"

void CS_TEST qBufGet_test0()
{
	/*Do not modify CS_TEST_PARAMETER()*/
	CS_TEST_PARAMETER(qBufGet_test0);
	/*Do not remove connect_stub_configuration()*/
	int cs_stub_connect_function_call = connect_qBufGet_test0_stub_configuration();
	{/*<START TEST>*/
	...
	/* int qBufGet(struct _QBuf_t *, unsigned char *, signed int) */
	returnVar = qBufGet(q,pBuf,size);
	...
	disConnect_qBufGet_test0_stub_configuration();
