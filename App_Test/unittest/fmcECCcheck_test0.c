#line 2 "cs_test%fmcECCcheck_test0%cs_error"
/* fmcECCcheck_test0.c */
#ifndef __fmcECCcheck_test0__
#define __fmcECCcheck_test0__

#include "../factory/factory.h"

#include "fmcECCcheck_test0.h"

void CS_TEST fmcECCcheck_test0()
{
	/*Do not modify CS_TEST_PARAMETER()*/
	CS_TEST_PARAMETER(fmcECCcheck_test0);
	/*Do not remove connect_stub_configuration()*/
	int cs_stub_connect_function_call = connect_fmcECCcheck_test0_stub_configuration();
	{/*<START TEST>*/
	...
	CS_UINT_OUTPUT(flashWREG_tmp_mem[0].FEDACSTATUS, "flashWREG_tmp_mem[0].FEDACSTATUS");

	/*<END TEST>*/}
	/*<CS_DISCONNECT_CODE_START>*/
	/*Do not remove disConnect_stub_configuration()*/
	disConnect_fmcECCcheck_test0_stub_configuration();
