#line 2 "cs_test%i2cReceive_test0%cs_error"
/* i2cReceive_test0.c */
#ifndef __i2cReceive_test0__
#define __i2cReceive_test0__

#include "../factory/factory.h"

#include "i2cReceive_test0.h"

void CS_TEST i2cReceive_test0()
{
	/*Do not modify CS_TEST_PARAMETER()*/
	CS_TEST_PARAMETER(i2cReceive_test0);
	/*Do not remove connect_stub_configuration()*/
	int cs_stub_connect_function_call = connect_i2cReceive_test0_stub_configuration();
	{/*<START TEST>*/
	...
	/* i2cReceive(volatile struct i2cBase *, unsigned int, unsigned char *) */
	...
	disConnect_i2cReceive_test0_stub_configuration();
