#line 2 "cs_test%peripheral_Protection_Clr_test0%cs_error"
/* peripheral_Protection_Clr_test0.c */
#ifndef __peripheral_Protection_Clr_test0__
#define __peripheral_Protection_Clr_test0__

#include "../factory/factory.h"

#include "peripheral_Protection_Clr_test0.h"

void CS_TEST peripheral_Protection_Clr_test0()
{
	/*Do not modify CS_TEST_PARAMETER()*/
	CS_TEST_PARAMETER(peripheral_Protection_Clr_test0);
	/*Do not remove connect_stub_configuration()*/
	int cs_stub_connect_function_call = connect_peripheral_Protection_Clr_test0_stub_configuration();
	{/*<START TEST>*/
	...
	/* peripheral_Protection_Clr(struct peripheral_Quad_ChipSelect) */
	peripheral_Protection_Clr(peripheral_Quad_CS);
	...
	disConnect_peripheral_Protection_Clr_test0_stub_configuration();
