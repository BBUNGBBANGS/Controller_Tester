#line 2 "cs_test%het2ParityCheck_test0%cs_error"
/* het2ParityCheck_test0.c */
#ifndef __het2ParityCheck_test0__
#define __het2ParityCheck_test0__

#include "../factory/factory.h"

#include "het2ParityCheck_test0.h"

void CS_TEST het2ParityCheck_test0()
{
	/*Do not modify CS_TEST_PARAMETER()*/
	CS_TEST_PARAMETER(het2ParityCheck_test0);
	/*Do not remove connect_stub_configuration()*/
	int cs_stub_connect_function_call = connect_het2ParityCheck_test0_stub_configuration();
	{/*<START TEST>*/
	...
	disConnect_het2ParityCheck_test0_stub_configuration();
