#line 2 "cs_test%esmHighInterrupt_test0%cs_error"
/* esmHighInterrupt_test0.c */
#ifndef __esmHighInterrupt_test0__
#define __esmHighInterrupt_test0__

#include "../factory/factory.h"

#include "esmHighInterrupt_test0.h"

void CS_TEST esmHighInterrupt_test0()
{
	/*Do not modify CS_TEST_PARAMETER()*/
	CS_TEST_PARAMETER(esmHighInterrupt_test0);
	/*Do not remove connect_stub_configuration()*/
	int cs_stub_connect_function_call = connect_esmHighInterrupt_test0_stub_configuration();
	{/*<START TEST>*/
	...
	disConnect_esmHighInterrupt_test0_stub_configuration();
