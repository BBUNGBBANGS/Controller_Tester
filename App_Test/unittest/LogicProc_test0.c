#line 2 "cs_test%LogicProc_test0%cs_error"
/* LogicProc_test0.c */
#ifndef __LogicProc_test0__
#define __LogicProc_test0__

#include "../factory/factory.h"

#include "LogicProc_test0.h"

void CS_TEST LogicProc_test0()
{
	/*Do not modify CS_TEST_PARAMETER()*/
	CS_TEST_PARAMETER(LogicProc_test0);
	/*Do not remove connect_stub_configuration()*/
	int cs_stub_connect_function_call = connect_LogicProc_test0_stub_configuration();
	{/*<START TEST>*/

#line 1 "cs_test%LogicProc_test0%User code start"
...
#line 33 "cs_test%LogicProc_test0%cs_error"
	...
	disConnect_LogicProc_test0_stub_configuration();
