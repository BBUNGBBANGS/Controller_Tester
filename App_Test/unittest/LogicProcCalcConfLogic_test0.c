#line 2 "cs_test%LogicProcCalcConfLogic_test0%cs_error"
/* LogicProcCalcConfLogic_test0.c */
#ifndef __LogicProcCalcConfLogic_test0__
#define __LogicProcCalcConfLogic_test0__

#include "../factory/factory.h"

#include "LogicProcCalcConfLogic_test0.h"

void CS_TEST LogicProcCalcConfLogic_test0()
{
	/*Do not modify CS_TEST_PARAMETER()*/
	CS_TEST_PARAMETER(LogicProcCalcConfLogic_test0);
	/*Do not remove connect_stub_configuration()*/
	int cs_stub_connect_function_call = connect_LogicProcCalcConfLogic_test0_stub_configuration();
	{/*<START TEST>*/

#line 1 "cs_test%LogicProcCalcConfLogic_test0%User code start"
...
#line 28 "cs_test%LogicProcCalcConfLogic_test0%cs_error"
	...
	/* LogicProcCalcConfLogic(unsigned int, struct _ConfLogic_t *) */
	LogicProcCalcConfLogic(elipsed,pConf);
	...
	disConnect_LogicProcCalcConfLogic_test0_stub_configuration();
