#line 2 "cs_test%printf_test0%cs_error"
/* printf_test0.c */
#ifndef __printf_test0__
#define __printf_test0__

#include "../factory/factory.h"

#include "printf_test0.h"

void CS_TEST printf_test0()
{
	/*Do not modify CS_TEST_PARAMETER()*/
	CS_TEST_PARAMETER(printf_test0);
	/*Do not remove connect_stub_configuration()*/
	int cs_stub_connect_function_call = connect_printf_test0_stub_configuration();
	{/*<START TEST>*/

#line 1 "cs_test%printf_test0%User code start"
...
#line 28 "cs_test%printf_test0%cs_error"
	...
	_format = CS_STR_INPUT(char[1024],"_format");



	/* int printf(const char *, ...) */
	returnVar = printf(_format);
	...
	disConnect_printf_test0_stub_configuration();
