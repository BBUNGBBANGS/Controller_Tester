#line 2 "cs_test%PWMStop_test1%cs_error"
/* PWMStop_test1.c */
#ifndef __PWMStop_test1__
#define __PWMStop_test1__

#include "../factory/factory.h"

#include "PWMStop_test1.h"

void CS_TEST PWMStop_test1()
{
	/*Do not modify CS_TEST_PARAMETER()*/
	CS_TEST_PARAMETER(PWMStop_test1);
	/*Do not remove connect_stub_configuration()*/
	int cs_stub_connect_function_call = connect_PWMStop_test1_stub_configuration();
	{/*<START TEST>*/

#line 1 "cs_test%PWMStop_test1%User code start"
...
#line 28 "cs_test%PWMStop_test1%cs_error"
	...
	/* int PWMStop(signed int) */
	returnVar = PWMStop(nDO);
	...
	disConnect_PWMStop_test1_stub_configuration();
