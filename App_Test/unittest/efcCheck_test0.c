#line 2 "cs_test%efcCheck_test0%cs_error"
/* efcCheck_test0.c */
#ifndef __efcCheck_test0__
#define __efcCheck_test0__

#include "../factory/factory.h"

#include "efcCheck_test0.h"

void CS_TEST efcCheck_test0()
{
	/*Do not modify CS_TEST_PARAMETER()*/
	CS_TEST_PARAMETER(efcCheck_test0);
	/*Do not remove connect_stub_configuration()*/
	int cs_stub_connect_function_call = connect_efcCheck_test0_stub_configuration();
	{/*<START TEST>*/
	...
	disConnect_efcCheck_test0_stub_configuration();
