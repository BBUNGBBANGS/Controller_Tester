#line 2 "cs_test%rtiResetCounter_test0%cs_error"
/* rtiResetCounter_test0.c */
#ifndef __rtiResetCounter_test0__
#define __rtiResetCounter_test0__

#include "../factory/factory.h"

#include "rtiResetCounter_test0.h"

void CS_TEST rtiResetCounter_test0()
{
	/*Do not modify CS_TEST_PARAMETER()*/
	CS_TEST_PARAMETER(rtiResetCounter_test0);
	/*Do not remove connect_stub_configuration()*/
	int cs_stub_connect_function_call = connect_rtiResetCounter_test0_stub_configuration();
	{/*<START TEST>*/
	...
	/* unsigned int rtiResetCounter(unsigned int) */
	returnVar = rtiResetCounter(counter);
	...
	disConnect_rtiResetCounter_test0_stub_configuration();
