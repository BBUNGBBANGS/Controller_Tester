#line 2 "cs_test%can2ParityCheck_test0%cs_error"
/* can2ParityCheck_test0.c */
#ifndef __can2ParityCheck_test0__
#define __can2ParityCheck_test0__

#include "../factory/factory.h"

#include "can2ParityCheck_test0.h"

void CS_TEST can2ParityCheck_test0()
{
	/*Do not modify CS_TEST_PARAMETER()*/
	CS_TEST_PARAMETER(can2ParityCheck_test0);
	/*Do not remove connect_stub_configuration()*/
	int cs_stub_connect_function_call = connect_can2ParityCheck_test0_stub_configuration();
	{/*<START TEST>*/
	...
	CS_UINT_OUTPUT(canREG2_tmp_mem[0].ES, "canREG2_tmp_mem[0].ES");
	CS_UINT_OUTPUT(canREG2_tmp_mem[0].TEST, "canREG2_tmp_mem[0].TEST");
	CS_UINT_OUTPUT(esmREG_tmp_mem[0].SR1[0], "esmREG_tmp_mem[0].SR1[0]");

	/*<END TEST>*/}
	/*<CS_DISCONNECT_CODE_START>*/
	/*Do not remove disConnect_stub_configuration()*/
	disConnect_can2ParityCheck_test0_stub_configuration();
