#line 2 "cs_test%dwdInit_test0%cs_error"
/* dwdInit_test0.c */
#ifndef __dwdInit_test0__
#define __dwdInit_test0__

#include "../factory/factory.h"

#include "dwdInit_test0.h"

void CS_TEST dwdInit_test0()
{
	/*Do not modify CS_TEST_PARAMETER()*/
	CS_TEST_PARAMETER(dwdInit_test0);
	/*Do not remove connect_stub_configuration()*/
	int cs_stub_connect_function_call = connect_dwdInit_test0_stub_configuration();
	{/*<START TEST>*/
	...
	disConnect_dwdInit_test0_stub_configuration();
