#line 2 "cs_test%sciEnableNotification_test0%cs_error"
/* sciEnableNotification_test0.c */
#ifndef __sciEnableNotification_test0__
#define __sciEnableNotification_test0__

#include "../factory/factory.h"

#include "sciEnableNotification_test0.h"

void CS_TEST sciEnableNotification_test0()
{
	/*Do not modify CS_TEST_PARAMETER()*/
	CS_TEST_PARAMETER(sciEnableNotification_test0);
	/*Do not remove connect_stub_configuration()*/
	int cs_stub_connect_function_call = connect_sciEnableNotification_test0_stub_configuration();
	{/*<START TEST>*/
	...
	/* sciEnableNotification(volatile struct sciBase *, unsigned int) */
	sciEnableNotification(sci,flags);
	...
	disConnect_sciEnableNotification_test0_stub_configuration();
