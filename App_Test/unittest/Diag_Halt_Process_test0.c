#line 2 "cs_test%Diag_Halt_Process_test0%cs_error"
/* Diag_Halt_Process_test0.c */
#ifndef __Diag_Halt_Process_test0__
#define __Diag_Halt_Process_test0__

#include "../factory/factory.h"

#include "Diag_Halt_Process_test0.h"

void CS_TEST Diag_Halt_Process_test0()
{
	/*Do not modify CS_TEST_PARAMETER()*/
	CS_TEST_PARAMETER(Diag_Halt_Process_test0);
	/*Do not remove connect_stub_configuration()*/
	int cs_stub_connect_function_call = connect_Diag_Halt_Process_test0_stub_configuration();
	{/*<START TEST>*/

#line 1 "cs_test%Diag_Halt_Process_test0%User code start"
...
#line 29 "cs_test%Diag_Halt_Process_test0%cs_error"
	...
	/* int Diag_Halt_Process() */
	returnVar = Diag_Halt_Process();
	...
	disConnect_Diag_Halt_Process_test0_stub_configuration();
