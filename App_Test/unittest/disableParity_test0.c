#line 2 "cs_test%disableParity_test0%cs_error"
/* disableParity_test0.c */
#ifndef __disableParity_test0__
#define __disableParity_test0__

#include "../factory/factory.h"

#include "disableParity_test0.h"

void CS_TEST disableParity_test0()
{
	/*Do not modify CS_TEST_PARAMETER()*/
	CS_TEST_PARAMETER(disableParity_test0);
	/*Do not remove connect_stub_configuration()*/
	int cs_stub_connect_function_call = connect_disableParity_test0_stub_configuration();
	{/*<START TEST>*/

#line 1 "cs_test%disableParity_test0%User code start"
#define DMA_PARCR		(*(volatile uint32 *)(0xFFFFF1A8U))
#define VIM_PARCTL      (*(volatile uint32 *)0xFFFFFDF0U)
#line 22 "cs_test%disableParity_test0%cs_error"
	...
	disConnect_disableParity_test0_stub_configuration();
