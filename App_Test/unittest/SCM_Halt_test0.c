#line 2 "cs_test%SCM_Halt_test0%cs_error"
/* SCM_Halt_test0.c */
#ifndef __SCM_Halt_test0__
#define __SCM_Halt_test0__

#include "../factory/factory.h"

#include "SCM_Halt_test0.h"

void CS_TEST SCM_Halt_test0()
{
	/*Do not modify CS_TEST_PARAMETER()*/
	CS_TEST_PARAMETER(SCM_Halt_test0);
	/*Do not remove connect_stub_configuration()*/
	int cs_stub_connect_function_call = connect_SCM_Halt_test0_stub_configuration();
	{/*<START TEST>*/

#line 1 "cs_test%SCM_Halt_test0%User code start"
...
#line 28 "cs_test%SCM_Halt_test0%cs_error"
	...
	disConnect_SCM_Halt_test0_stub_configuration();
