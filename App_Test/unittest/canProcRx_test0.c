#line 2 "cs_test%canProcRx_test0%cs_error"
/* canProcRx_test0.c */
#ifndef __canProcRx_test0__
#define __canProcRx_test0__

#include "../factory/factory.h"

#include "canProcRx_test0.h"

void CS_TEST canProcRx_test0()
{
	/*Do not modify CS_TEST_PARAMETER()*/
	CS_TEST_PARAMETER(canProcRx_test0);
	/*Do not remove connect_stub_configuration()*/
	int cs_stub_connect_function_call = connect_canProcRx_test0_stub_configuration();
	{/*<START TEST>*/

#line 1 "cs_test%canProcRx_test0%User code start"
...
#line 28 "cs_test%canProcRx_test0%cs_error"
	...
	disConnect_canProcRx_test0_stub_configuration();
