#line 2 "cs_test%i2c_R_test0%cs_error"
/* i2c_R_test0.c */
#ifndef __i2c_R_test0__
#define __i2c_R_test0__

#include "../factory/factory.h"

#include "i2c_R_test0.h"

void CS_TEST i2c_R_test0()
{
	/*Do not modify CS_TEST_PARAMETER()*/
	CS_TEST_PARAMETER(i2c_R_test0);
	/*Do not remove connect_stub_configuration()*/
	int cs_stub_connect_function_call = connect_i2c_R_test0_stub_configuration();
	{/*<START TEST>*/

#line 1 "cs_test%i2c_R_test0%User code start"
...
#line 38 "cs_test%i2c_R_test0%cs_error"
	...
	/* uint8_t * i2c_R(unsigned char, unsigned char *, unsigned char) */
	returnVar = i2c_R(add,rdata,data_length);
	...
	disConnect_i2c_R_test0_stub_configuration();
