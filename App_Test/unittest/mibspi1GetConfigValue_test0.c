#line 2 "cs_test%mibspi1GetConfigValue_test0%cs_error"
/* mibspi1GetConfigValue_test0.c */
#ifndef __mibspi1GetConfigValue_test0__
#define __mibspi1GetConfigValue_test0__

#include "../factory/factory.h"

#include "mibspi1GetConfigValue_test0.h"

void CS_TEST mibspi1GetConfigValue_test0()
{
	/*Do not modify CS_TEST_PARAMETER()*/
	CS_TEST_PARAMETER(mibspi1GetConfigValue_test0);
	/*Do not remove connect_stub_configuration()*/
	int cs_stub_connect_function_call = connect_mibspi1GetConfigValue_test0_stub_configuration();
	{/*<START TEST>*/
	...
	mibspiREG1_tmp_mem[0].LVL = CS_UINT_INPUT(unsigned int,"mibspiREG1_tmp_mem[0].LVL");
	mibspiREG1_tmp_mem[0].PC0 = CS_UINT_INPUT(unsigned int,"mibspiREG1_tmp_mem[0].PC0");
	mibspiREG1_tmp_mem[0].PC1 = CS_UINT_INPUT(unsigned int,"mibspiREG1_tmp_mem[0].PC1");
	mibspiREG1_tmp_mem[0].PC6 = CS_UINT_INPUT(unsigned int,"mibspiREG1_tmp_mem[0].PC6");
	mibspiREG1_tmp_mem[0].PC7 = CS_UINT_INPUT(unsigned int,"mibspiREG1_tmp_mem[0].PC7");
	mibspiREG1_tmp_mem[0].PC8 = CS_UINT_INPUT(unsigned int,"mibspiREG1_tmp_mem[0].PC8");
	...
	/* mibspi1GetConfigValue(struct mibspi_config_reg *, enum config_value_type) */
	mibspi1GetConfigValue(config_reg,type);
	...
	disConnect_mibspi1GetConfigValue_test0_stub_configuration();
