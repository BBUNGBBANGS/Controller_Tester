#line 2 "cs_test%LogicProcInputPI_test0%cs_error"
/* LogicProcInputPI_test0.c */
#ifndef __LogicProcInputPI_test0__
#define __LogicProcInputPI_test0__

#include "../factory/factory.h"

#include "LogicProcInputPI_test0.h"

void CS_TEST LogicProcInputPI_test0()
{
	/*Do not modify CS_TEST_PARAMETER()*/
	CS_TEST_PARAMETER(LogicProcInputPI_test0);
	/*Do not remove connect_stub_configuration()*/
	int cs_stub_connect_function_call = connect_LogicProcInputPI_test0_stub_configuration();
	{/*<START TEST>*/

#line 1 "cs_test%LogicProcInputPI_test0%User code start"
...
#line 35 "cs_test%LogicProcInputPI_test0%cs_error"
	...
	disConnect_LogicProcInputPI_test0_stub_configuration();
