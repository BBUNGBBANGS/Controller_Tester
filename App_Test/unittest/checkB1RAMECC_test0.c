#line 2 "cs_test%checkB1RAMECC_test0%cs_error"
/* checkB1RAMECC_test0.c */
#ifndef __checkB1RAMECC_test0__
#define __checkB1RAMECC_test0__

#include "../factory/factory.h"

#include "checkB1RAMECC_test0.h"

void CS_TEST checkB1RAMECC_test0()
{
	/*Do not modify CS_TEST_PARAMETER()*/
	CS_TEST_PARAMETER(checkB1RAMECC_test0);
	/*Do not remove connect_stub_configuration()*/
	int cs_stub_connect_function_call = connect_checkB1RAMECC_test0_stub_configuration();
	{/*<START TEST>*/
	...
	disConnect_checkB1RAMECC_test0_stub_configuration();
